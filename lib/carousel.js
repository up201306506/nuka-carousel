...
var Carousel = _React2['default'].createClass({
  ...
  getFrameStyles: function getFrameStyles() {
    return {
      maxWidth: this.props.fullWidth ? this.props.fullWidth : null,
      position: 'relative',
      display: 'block',
      overflow: 'hidden',
  ...
  getSliderStyles: function getSliderStyles() {
    return {
      position: 'relative',
      display: 'block',
      maxWidth: this.props.fullWidth && (this.props.width > this.props.fullWidth)   ? this.props.fullWidth : this.props.width,
      width: this.props.fullWidth ? this.props.fullWidth : this.props.width,
      boxSizing: 'border-box',
      MozBoxSizing: 'border-box'
    };
  },
